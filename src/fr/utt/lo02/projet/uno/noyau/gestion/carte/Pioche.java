...
/**
 *  La classe Pioche permet de g�rer la pioche du jeu de Uno. Cette classe suit le design pattern Singleton.
 *  Elle n'est instanci�e qu'une fois.
 */
public class Pioche {
	...
	/**
	 * Cette m�thode permet d'ajouter une carte � la pioche.
	 * @param carte
	 * 		La carte � ajouter.
	 */
	...
	/**
	 * Cette m�thode renvoie le nombre de carte de la pioche.
	 * @return
	 * 		Renvoie un entier �tant le nombre de carte
	 */
	...
	/**
	 * Cette m�thode permet de retirer une carte de la pioche.
	 * @return
	 * 		Renvoie la carte retir�e du paquet
	 */
	...
	/**
	 * Cette m�thode permet d r�cup�rer l'unique instance de la classe Pioche.
	 * @return
	...
	/**
	 * Cette m�thode permet de r�initialiser l'instance de la classe Pioche.
	 */
